...
The contact button uses `mailto:` because GitHub Pages is static hosting. It opens the visitor's default mail app with a message addressed to `rainer33@naver.com`.
